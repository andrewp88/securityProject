...
if ( ! class_exists('jobcareer_meta_fields') ) {
    ...
    class jobcareer_meta_fields {
                            ...
                            if ( $attachments ) {
                                foreach ( $attachments as $attachment_id ) {
                                    ...
                                    echo '<li class="image" data-attachment_id="' . esc_attr($attachment_id) . '">
                                        ' . $attachment_data . '
                                        <div class="actions">
                                            <span><a href="javascript:;" class="delete tips" data-tip="' . esc_html__('Delete image', 'jobcareer') . '"><i class="icon-times"></i></a></span>
                                        </div>
                                    </li>';
                                }
                            }
        ...
        public function cs_media_url($params = '') {
            ...
            $cs_output = '<div class="form-elements audio-video-holder">
                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">';
            ...
            $cs_output .='<div class="media-text-holder">';
            $cs_output .= $jobcareer_form_fields->cs_form_text_render($cs_opt_array);
            $cs_output .='</div>';
