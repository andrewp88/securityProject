...
class WP_nav_menu_widget_chimp extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            'description' => esc_html__('Add a custom menu to your sidebar.', 'jobcareer'),
            'customize_selective_refresh' => true,
        );
        parent::__construct('nav_menu_chimp', esc_html__('CS: Custom Menu', 'jobcareer'), $widget_ops);
    }
    ...
    public function form($instance) {
        ...
        <p class="nav-menu-widget-no-menus-message" <?php if ( ! empty($menus) ) {
            ...
            ?>
        <?php echo '<p>' . sprintf(esc_html__('No menus have been created yet. ', 'jobcareer') . '<a href="%s">' . esc_html__('Create some', 'jobcareer') . '</a>', esc_url($url)) . '</p>'; ?>
        </p>
...
add_action('widgets_init', function() {
    return register_widget("WP_nav_menu_widget_chimp");
});
