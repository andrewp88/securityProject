...
if ( ! function_exists('jobcareer_shortcode_names') ) {
    ...
    function jobcareer_shortcode_names() {
        ...
        $shortcode_array = array(
            'about' => array(
                'title' => esc_html__('About', 'jobcareer'),
                'name' => 'about',
                'icon' => 'icon-text',
        ...
        if ( class_exists('wp_jobhunt') ) {
            ...
            $shortcode_array['listing_tab'] = array(
             ...
             $shortcode_array['jobs_map'] = array(
                'title' => esc_html__('JC : Jobs with Map', 'jobcareer'),
                'name' => 'jobs_map',
                'icon' => 'icon-table',
                'categories' => 'loops misc',
            );
        ...
        $shortcode_array    = apply_filters( 'jobcareer_shortcodes_array', $shortcode_array );
        ...
        if ( isset($_POST['shortcode_element']) && $_POST['shortcode_element'] ) {
            if ( $_POST['shortcode_element'] == 'accordions' ) {
                ...
                <div class='cs-wrapp-clone cs-shortcode-wrapp cs-pbwp-content'  id="cs_infobox_<?php echo intval($rand_id); ?>">
                    ...
                    ?>
                    <script>
                        var testimonial_view = $('#cs_testimonial_style_id').val();
                        if (testimonial_view == 'fancy') {
                            $('.fancy-hide-show').show();
                        } else {
                            $('.fancy-hide-show').hide();
                        }
                    </script>
                    <?php
                    echo '<div class="fancy-hide-show">';
                    $cs_opt_array = array(
