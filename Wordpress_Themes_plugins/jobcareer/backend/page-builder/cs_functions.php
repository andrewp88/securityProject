...
if ( ! function_exists('jobcareer_ajax_element_setting') ) {
    ...
    function jobcareer_ajax_element_setting($name, $cs_counter, $element_size, $shortcode_element_id, $POSTID, $element_description = '', $page_element_icon = '', $type = '') {
        ...
        <div class="column-in">
            ...
            echo jobcareer_special_char($jobcareer_form_fields->cs_form_hidden_render($cs_opt_array));
            ?>
            <a href="javascript:;" onclick="javascript:ajax_shortcode_widget_element(jQuery(this), '<?php echo esc_js(admin_url('admin-ajax.php')); ?>', '<?php echo esc_js($POSTID); ?>', '<?php echo esc_js($name); ?>')" class="options"><i class="icon-gear"></i></a>
            <a href="#" class="delete-it btndeleteit"><i class="icon-trash-o"></i></a> &nbsp;
            <?php
            $icon_skip_array = array( "multi_counters", "spacer" );
            if ( ! in_array($name, $icon_skip_array) ) {
                ?>
                <a class="decrement" onclick="javascript:decrement(this)"><i class="icon-minus4"></i></a>
                &nbsp;
                <a class="increment" onclick="javascript:increment(this)"><i class="icon-plus3"></i></a>
...
if ( ! function_exists('jobcareer_element_list') ) {
    ...
    function jobcareer_element_list() {
	    ...
	    'membership package' => esc_html__('Apply Job Package', 'jobcareer'),
            ...
            'jobs_map' => esc_html__('JC : Jobs with Map', 'jobcareer'),
            'jobs map' => esc_html__('JC : Jobs with Map', 'jobcareer'),
...
if ( ! function_exists('jobcareer_media_pagination') ) {
    ...
    function jobcareer_media_pagination($id = '', $func = 'clone') {
        ...
        <?php
        if ( $page_id > 1 ) {
            echo "<li><a href='javascript:show_next(" . ($page_id - 1) . ",$total_pages)'>" . esc_html__('Prev', 'jobcareer') . "</a></li>";
        }
        ...
        if ( $page_id < $total_pages / $records_per_page ) {
            echo "<li><a href='javascript:show_next(" . ($page_id + 1) . ",$total_pages)'>" . esc_html__('Next', 'jobcareer') . "</a></li>";
        }
        ?>
            </ul>
        </div>
        ...
        <script>
            jQuery(document).ready(function ($) {
                ...
                $('#e9_buttons_<?php echo jobcareer_special_char($id); ?> button').on('click', function (e) {
                    ...
                    $(this).prop('disabled', true).html('<i class="icon-cog demo-animate-spin"></i> <?php esc_html_e("Please wait...", 'jobcareer'); ?>');
                    $.ajax({
...
// Get all Categories of posts or custom posts
    ...
    if ( ! function_exists('jobcareer_add_banner_fields') ) {
        ...
        function jobcareer_add_banner_fields() {
            ...
            $banner_field_style_selected = '';
            if ( isset($_POST['banner_field_style']) && $_POST['banner_field_style'] == 'top_banner' ) {
                $banner_field_style_selected = 'top_banner';
            } elseif ( isset($_POST['banner_field_style']) && $_POST['banner_field_style'] == 'bottom_banner' ) {
                $banner_field_style_selected = 'bottom_banner';
            } elseif ( isset($_POST['banner_field_style']) && $_POST['banner_field_style'] == 'sidebar_banner' ) {
                $banner_field_style_selected = 'sidebar_banner';
            } elseif ( isset($_POST['banner_field_style']) && $_POST['banner_field_style'] == 'vertical_banner' ) {
                $banner_field_style_selected = 'vertical_banner';
            }

            $banner_field_type_selected = '';
            if ( isset($_POST['banner_field_type']) && $_POST['banner_field_type'] == 'image' ) {
                $banner_field_type_selected = 'image';
            } elseif ( isset($_POST['banner_field_type']) && $_POST['banner_field_type'] == 'code' ) {
                $banner_field_type_selected = 'code';
            }
            ...
            $banner_field_url_target_selected = '';
            if ( isset($_POST['banner_field_url_target']) && $_POST['banner_field_url_target'] == '_self' ) {
                $banner_field_url_target_selected = '_self';
            } elseif ( isset($_POST['banner_field_url_target']) && $_POST['banner_field_url_target'] == '_blank' ) {
                $banner_field_url_target_selected = '_blank';
            }
            $js_alert_conf = esc_html__('Are you sure! You want to delete this', 'jobcareer');
            ...
            $output .= $jobcareer_form_fields->cs_form_select_render(array(
                'std' => $banner_field_style_selected,
            ...
            $output .= $jobcareer_form_fields->cs_form_select_render(array(
                'std' => $banner_field_type_selected,
                'cust_id' => 'banner-style' . $cs_rand_id,
...
//        $output .= $jobcareer_form_fields->cs_form_text_render($cs_opt_array);
            ...
            $output .= $jobcareer_form_fields->cs_form_select_render(array(
                'std' => $banner_field_url_target_selected,
                'cust_id' => 'banner-style' . $cs_rand_id,
