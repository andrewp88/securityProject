    ...
    if ( ! function_exists('save_page_builder') ) {
        ...
        function save_page_builder($post_id) {
            ...
            if ( isset($_POST['builder_active']) ) {
                ...
                $cs_global_counter_jobs_map = 0;
                $cs_shortcode_counter_jobs_map = 0;
                $cs_counter_jobs_map = 0;
                            ...
                            for ( $j = 1; $j <= $a; $j ++ ) {
                                ...
                                // Save heading page element
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['heading_font_weight'][$cs_counter_heading]) && $_POST['heading_font_weight'][$cs_counter_heading] != '' ) {
                                            $shortcode .= 'heading_font_weight="' . htmlspecialchars($_POST['heading_font_weight'][$cs_counter_heading]) . '" ';
                                        }
                                        ...
                                        if ( isset($_POST['heading_padding'][$cs_counter_heading]) && $_POST['heading_padding'][$cs_counter_heading] != '' ) {
                                            $shortcode .= 'heading_padding="' . htmlspecialchars($_POST['heading_padding'][$cs_counter_heading], ENT_QUOTES) . '" ';
                                        }
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['cs_newsletter_style'][$cs_counter_newsletter]) && $_POST['cs_newsletter_style'][$cs_counter_newsletter] != '' ) {
                                            $shortcode .= 'cs_newsletter_style="' . htmlspecialchars($_POST['cs_newsletter_style'][$cs_counter_newsletter], ENT_QUOTES) . '" ';
                                        }
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['testimonials_num'][$cs_counter_testimonials]) && $_POST['testimonials_num'][$cs_counter_testimonials] > 0 ) {
                                            for ( $i = 1; $i <= $_POST['testimonials_num'][$cs_counter_testimonials]; $i ++ ) {
                                                ...
                                                if ( isset($_POST['testimonial_facebook'][$cs_counter_testimonials_node]) && $_POST['testimonial_facebook'][$cs_counter_testimonials_node] != '' ) {
                                                    $shortcode_item .= 'testimonial_facebook="' . htmlspecialchars($_POST['testimonial_facebook'][$cs_counter_testimonials_node], ENT_QUOTES) . '" ';
                                                }if ( isset($_POST['testimonial_twitter'][$cs_counter_testimonials_node]) && $_POST['testimonial_twitter'][$cs_counter_testimonials_node] != '' ) {
                                                    $shortcode_item .= 'testimonial_twitter="' . htmlspecialchars($_POST['testimonial_twitter'][$cs_counter_testimonials_node], ENT_QUOTES) . '" ';
                                                }if ( isset($_POST['testimonial_google'][$cs_counter_testimonials_node]) && $_POST['testimonial_google'][$cs_counter_testimonials_node] != '' ) {
                                                    $shortcode_item .= 'testimonial_google="' . htmlspecialchars($_POST['testimonial_google'][$cs_counter_testimonials_node], ENT_QUOTES) . '" ';
                                                }
                                                $shortcode_item .= ']';
                                ...
                                // Membership Package
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['membership_package_title'][$cs_counter_membership_package]) && $_POST['membership_package_title'][$cs_counter_membership_package] != '' ) {
                                        ...
                                        if ( isset($_POST['cs_membershi_pkg_id'][$cs_counter_membership_package]) && $_POST['cs_membershi_pkg_id'][$cs_counter_membership_package] != '' ) {
                                            ...
                                            if ( isset($_POST['membership_packages'][$cs_membershi_pkg_id]) && $_POST['membership_packages'][$cs_membershi_pkg_id] != '' ) {
                                ...
                                // Job Specialisms
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['job_specialisms_view_all_link'][$cs_counter_job_specialisms]) && $_POST['job_specialisms_view_all_link'][$cs_counter_job_specialisms] != '' ) {
                                            $shortcode .= ' job_specialisms_view_all_link="' . htmlspecialchars($_POST['job_specialisms_view_all_link'][$cs_counter_job_specialisms], ENT_QUOTES) . '" ';
                                        }
                                        $shortcode .= ']';
                                        if ( isset($_POST['job_specialisms_content'][$cs_counter_job_specialisms]) && $_POST['job_specialisms_content'][$cs_counter_job_specialisms] != '' ) {
                                            $shortcode .= htmlspecialchars($_POST['job_specialisms_content'][$cs_counter_job_specialisms], ENT_QUOTES);
                                        }
                                        $shortcode .= '[/cs_job_specialisms]';
                                ...
                                } else if ( $_POST['cs_orderby'][$cs_counter] == "jobs_map" ) {
                                    $shortcode = '';
                                    $jobs_map = $column->addChild('jobs_map');
                                    $jobs_map->addChild('jobs_map_element_size', $_POST['jobs_map_element_size'][$cs_global_counter_jobs_map]);
                                    $jobs_map->addChild('page_element_size', $_POST['jobs_map_element_size'][$cs_global_counter_jobs_map]);
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        $shortcode_str = stripslashes($_POST['shortcode']['jobs_map'][$cs_shortcode_counter_jobs_map]);
                                        $cs_shortcode_counter_jobs_map ++;
                                        $jobs_map->addChild('cs_shortcode', htmlspecialchars($shortcode_str));
                                    } else {
                                        $shortcode .= '[cs_jobs_map ';
                                        if ( isset($_POST['jobs_map_element_title'][$cs_counter_jobs_map]) && $_POST['jobs_map_element_title'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_map_element_title="' . htmlspecialchars($_POST['jobs_map_element_title'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['jobs_map_element_subtitle'][$cs_counter_jobs_map]) && $_POST['jobs_map_element_subtitle'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_map_element_subtitle="' . htmlspecialchars($_POST['jobs_map_element_subtitle'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['jobs_maps_latitude'][$cs_counter_jobs_map]) && $_POST['jobs_maps_latitude'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_maps_latitude="' . htmlspecialchars($_POST['jobs_maps_latitude'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['jobs_map_longitude'][$cs_counter_jobs_map]) && $_POST['jobs_map_longitude'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_map_longitude="' . htmlspecialchars($_POST['jobs_map_longitude'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['jobs_map_zoom_level'][$cs_counter_jobs_map]) && $_POST['jobs_map_zoom_level'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_map_zoom_level="' . htmlspecialchars($_POST['jobs_map_zoom_level'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['jobs_map_container_height'][$cs_counter_jobs_map]) && $_POST['jobs_map_container_height'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_map_container_height="' . htmlspecialchars($_POST['jobs_map_container_height'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['jobs_map_marker_icon'][$cs_counter_jobs_map]) && $_POST['jobs_map_marker_icon'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_map_marker_icon="' . htmlspecialchars($_POST['jobs_map_marker_icon'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
					if ( isset($_POST['jobs_map_cluster_icon'][$cs_counter_jobs_map]) && $_POST['jobs_map_cluster_icon'][$cs_counter_jobs_map] != '' ) {
                                            $shortcode .= ' jobs_map_cluster_icon="' . htmlspecialchars($_POST['jobs_map_cluster_icon'][$cs_counter_jobs_map], ENT_QUOTES) . '" ';
                                        }
                                        $shortcode .= ']';
                                        $shortcode .= '[/cs_jobs_map]';
                                        $jobs_map->addChild('cs_shortcode', $shortcode);
                                        $cs_counter_jobs_map ++;
                                    }
                                    $cs_global_counter_jobs_map ++;
...
//                                                }
                                ...
                                // Blog
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['cs_blog_element_subtitle'][$cs_counter_blog]) && $_POST['cs_blog_element_subtitle'][$cs_counter_blog] != '' ) {
                                            $shortcode .= 'cs_blog_element_subtitle="' . htmlspecialchars($_POST['cs_blog_element_subtitle'][$cs_counter_blog], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['cs_blog_alignment'][$cs_counter_blog]) && $_POST['cs_blog_alignment'][$cs_counter_blog] != '' ) {
                                            $shortcode .= 'cs_blog_alignment="' . htmlspecialchars($_POST['cs_blog_alignment'][$cs_counter_blog], ENT_QUOTES) . '" ';
                                        }
                                ...
                                // video
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['cs_icon_box_icon'][$counter_about]) && $_POST['cs_icon_box_icon'][$counter_about] != '' ) {
                                            $shortcode .= 'cs_icon_box_icon="' . htmlspecialchars($_POST['cs_icon_box_icon'][$counter_about]) . '" ';
                                        }
                                ...
                                // Clients
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['cs_clients_pagination_switch'][$cs_counter_clients]) && $_POST['cs_clients_pagination_switch'][$cs_counter_clients] != '' ) {
                                            $shortcode .= 'cs_clients_pagination_switch="' . htmlspecialchars($_POST['cs_clients_pagination_switch'][$cs_counter_clients]) . '" ';
                                        }
                                ...
                                // Multiple services
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['cs_employer_all_companies'][$cs_counter_employer]) && $_POST['cs_employer_all_companies'][$cs_counter_employer] != '' ) {
                                            $shortcode .= 'cs_employer_all_companies="' . htmlspecialchars($_POST['cs_employer_all_companies'][$cs_counter_employer]) . '" ';
                                        }
                                    ...
                                    if ( isset($_POST['cs_widget_element_num'][$cs_counter]) && $_POST['cs_widget_element_num'][$cs_counter] == 'shortcode' ) {
                                        ...
                                        if ( isset($_POST['cs_job_map'][$cs_counter_job]) && $_POST['cs_job_map'][$cs_counter_job] != '' ) {
                                            $shortcode .= 'cs_job_map="' . htmlspecialchars($_POST['cs_job_map'][$cs_counter_job], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['cs_job_map_lat'][$cs_counter_job]) && $_POST['cs_job_map_lat'][$cs_counter_job] != '' ) {
                                            $shortcode .= 'cs_job_map_lat="' . htmlspecialchars($_POST['cs_job_map_lat'][$cs_counter_job], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['cs_job_map_long'][$cs_counter_job]) && $_POST['cs_job_map_long'][$cs_counter_job] != '' ) {
                                            $shortcode .= 'cs_job_map_long="' . htmlspecialchars($_POST['cs_job_map_long'][$cs_counter_job], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['cs_job_map_zoom'][$cs_counter_job]) && $_POST['cs_job_map_zoom'][$cs_counter_job] != '' ) {
                                            $shortcode .= 'cs_job_map_zoom="' . htmlspecialchars($_POST['cs_job_map_zoom'][$cs_counter_job], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['cs_job_map_height'][$cs_counter_job]) && $_POST['cs_job_map_height'][$cs_counter_job] != '' ) {
                                            $shortcode .= 'cs_job_map_height="' . htmlspecialchars($_POST['cs_job_map_height'][$cs_counter_job], ENT_QUOTES) . '" ';
                                        }
                                        if ( isset($_POST['cs_job_map_style'][$cs_counter_job]) && $_POST['cs_job_map_style'][$cs_counter_job] != '' ) {
                                            $shortcode .= 'cs_job_map_style="' . htmlspecialchars($_POST['cs_job_map_style'][$cs_counter_job], ENT_QUOTES) . '" ';
                                        }
