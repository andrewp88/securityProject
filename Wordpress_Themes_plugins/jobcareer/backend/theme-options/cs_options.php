...
if ( ! function_exists('jobcareer_theme_option') ) {
    ...
    function jobcareer_theme_option() {
        ...
        $navigation_style = array( "left" => esc_html__('left', 'jobcareer'), "center" => esc_html__('center', 'jobcareer'), "right" => esc_html__('right', 'jobcareer') );
        ...
        $breadcrumb_option = array( "option1" => esc_html__('option1', 'jobcareer'), "option2" => esc_html__('option2', 'jobcareer'), "option3" => esc_html__('option3', 'jobcareer') );
        ...
        $jobcareer_sett_options[] = array( "name" => esc_html__("Map Style", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Select Map style for all Maps.", "jobcareer"),
            "id" => "def_map_style",
            "std" => "",
            "type" => "select_values",
            'classes' => 'chosen-select-no-single',
            "options" => array(
                'map-box' => esc_html__('Map Box', 'jobcareer'),
                'blue-water' => esc_html__('Blue Water', 'jobcareer'),
                'icy-blue' => esc_html__('Icy Blue', 'jobcareer'),
                'bluish' => esc_html__('Bluish', 'jobcareer'),
                'light-blue-water' => esc_html__('Light Blue Water', 'jobcareer'),
                'clad-me' => esc_html__('Clad Me', 'jobcareer'),
                'chilled' => esc_html__('Chilled', 'jobcareer'),
                'two-tone' => esc_html__('Two Tone', 'jobcareer'),
                'light-and-dark' => esc_html__('Light and Dark', 'jobcareer'),
                'ilustracao' => esc_html__('Ilustracao', 'jobcareer'),
                'flat-pale' => esc_html__('Flat Pale', 'jobcareer'),
                'title' => esc_html__('Title', 'jobcareer'),
                'moret' => esc_html__('Moret', 'jobcareer'),
            ),
        );
...
//        }
        ...
        $jobcareer_sett_options[] = array(
            ...
            "desc" => "",
            "hint_text" => esc_html__("Select default header style here for all Detail Posts.", 'jobcareer'),
        ...
        $jobcareer_sett_options[] = array(
            "name" => esc_html__("Transparent Header view", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("Select transparent header style here for all pages and post.", 'jobcareer'),
            "id" => "cs_header_transparenr_view",
            "std" => "default-header-view",
            'classes' => 'chosen-select-no-single',
            "type" => "select_values",
            "options" => array(
                'default-header-view' => esc_html__("Default view", 'jobcareer'),
                'transparent-fancy' => esc_html__("Fancy", 'jobcareer'),
                'transparent-modern' => esc_html__("Modern", 'jobcareer'),
            ),
        );
        ...
        $jobcareer_sett_options[] = array( "name" => esc_html__("Header Border Color", 'jobcareer'),
            "desc" => "",
            "hint_text" => esc_html__("No subheader will be implemented on all default subheader pages.", 'jobcareer'),
...
//            );
        ...
        $jobcareer_sett_options[] = array(
            ...
            "type" => "select_values",
            "options" =>
            array( 'default-footer' => esc_html__("Default Footer", 'jobcareer'),
                'fancy-footer' => esc_html__("Fancy Footer", 'jobcareer'),
                'modern-footer' => esc_html__("Modern Footer", 'jobcareer'),
                'modern-footer2' => esc_html__("Modern Footer 2", 'jobcareer'),
                'classic-footer' => esc_html__("Classic", 'jobcareer'),
            ),
        );
        ...
        $jobcareer_sett_options[] = array( "name" => esc_html__("Copyright Text", 'jobcareer'),
            ...
            "id" => "cs_copy_right",
            "std" => "&copy; " . esc_html__('2018 Jobhunt Name All rights reserved. Design by', 'jobcareer') . " <a class='cscolor' href='#'>" . esc_html__('Chimp Studio', 'jobcareer') . "</a>",
            "type" => "textarea"
        );
        ...
        $jobcareer_sett_options[] = array( "name" => esc_html__("Mail Chimp Key", 'jobcareer'),
            "desc" => esc_html__("Enter a valid Mail Chimp API key here to get started. Once you've done that, you can use the Mail Chimp Widget from the Widgets menu. You will need to have at least Mail Chimp list set up before the using the widget. You can get your mail chimp activation key", 'jobcareer') . " <a href='https://login.mailchimp.com/' target='_blank'>" . esc_html__("Clicking Here", 'jobcareer') . " </a>",
            "hint_text" => esc_html__("Add your mailchimp key here", 'jobcareer'),
        ...
        $jobcareer_sett_options[] = array( "col_heading" => esc_html__("Attention User Account Information!", 'jobcareer'),
            ...
            "help_text" => esc_html__("To obtain your API Key, visit your \"My Settings\" page on any of the Envato 
							...
							possible the author has not made it available for auto install yet.", 'jobcareer')
        );
