                ...
                switch ( $value['type'] ) {
                    ...
                    case 'automatic_upgrade':
                        ...
                        if ( isset($_GET['action']) && $_GET['action'] == 'upgrade_theme' ) {
                            ...
                            if ( $msgStr != '' ) {
                                $message = esc_html__('Successfully installed ', 'jobcareer') . $msgStr;
                            } else {
                                $message = esc_html__('Sorry unable to upgrade theme. Contact Theme Author and repot this issue.', 'jobcareer');
                            }
                        ...
                        if ( $banner_fields <> '' ) {
                            foreach ( $banner_fields as $field ) {
                                ...
                                if ( isset($banner_fields[$i]) || isset($banner_fields[$i]) ) {
                                    ...
                                    } else if ( $banner_fields_style[$i] == 'vertical_banner' ) {
                                    ...
                                    if ( isset($banner_fields_type[$i]) && $banner_fields_type[$i] == 'image' ) {
                                        $banner_field_type_selected = 'image';
                                    } elseif ( isset($banner_fields_type[$i]) && $banner_fields_type[$i] == 'code' ) {
                                    ...
                                    if ( isset($banner_fields_url_target[$i]) && $banner_fields_url_target[$i] == '_self' ) {
                                        $banner_field_url_target_selected = '_self';
                                    } elseif ( isset($banner_fields_url_target[$i]) && $banner_fields_url_target[$i] == '_blank' ) {
                                    ...
                                    $output .= $jobcareer_form_fields->cs_form_select_render(array(
                                        'std' => isset($banner_field_style_selected) ? $banner_field_style_selected : '',
                                        'classes' => 'chosen-select-no-single',
                                    ...
                                    $output .= $jobcareer_form_fields->cs_form_select_render(array(
                                        'std' => isset($banner_field_type_selected) ? $banner_field_type_selected : '',
                                        'classes' => $cs_classes,
                                        'cust_id' => 'banner-style' . $cs_rand_id,
							...
							<div class="form-elements" id="cs_banner_image_field_' . $cs_rand_id . '" style="display:' . $cs_baner_image_display . ';">
								...
								<div  class="col-lg-8 col-md-8 col-sm-12 col-xs-12" id="cs_banner_image_value_' . $cs_rand_id . '" >';
                                    ...
                                    $output .= $jobcareer_form_fields->cs_form_select_render(array(
                                        'std' => isset($banner_field_url_target_selected) ? $banner_field_url_target_selected : '',
                                        'classes' => 'chosen-select-no-single',
                                        'cust_id' => 'banner-style' . $cs_rand_id,
