...
jQuery(document).on("click", ".jobcareer-notice-warning button.notice-dismiss", function () {
    var admin_url = jQuery(this).parents('div.jobcareer-notice-warning').data('ajax-url');
    var newCustomerForm = "admin=yes&action=jobcareer_admin_dismiss_notice";
    jQuery.ajax({
        type: "POST",
        url: admin_url,
        data: newCustomerForm,
