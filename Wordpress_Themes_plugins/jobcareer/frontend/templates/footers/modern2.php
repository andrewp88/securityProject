			...
			<div class="footer-links">
				...
				<div class="row">
					...
					if (isset($cs_copy_right) and $cs_copy_right <> '') {
						...
						echo '
						<p class="copyrights">
						' . gmdate("Y") . ' ' . esc_html__('Jobs Wordpress Theme All rights reserved. Design by', 'jobcareer') . '	<a href="'.esc_url('www.chimpgroup.com').'" target="_blank">' . get_option("blogname") . '</a>
						</p>';
					}
					echo '</div>';
					?> 
