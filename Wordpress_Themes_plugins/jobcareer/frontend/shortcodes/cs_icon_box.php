...
if ( ! function_exists('jobcareer_icon_box_shortcode') ) {
    ...
    function jobcareer_icon_box_shortcode($atts, $content = "") {
        ...
        if ( $cs_icon_box_view == "cs-box" ) {
            ...
            $cs_html .= '</div></div>';
        } elseif ( $cs_icon_box_view == "modern" ) {
            $cs_html .='<div class="row">';
            $cs_html .= jobcareer_special_char($cs_section_title);
            $cs_html .= '<ul class="cs-modern" ' . $cs_main_title_color_str . '>';
            $cs_html .= do_shortcode($content);
            $cs_html .= '</ul>';
            $cs_html .='</div>'; //end row
        } else {
            $cs_html .= '<div class="cs-simple fancy-box" ' . $cs_main_title_color_str . '><div class="row">';
            $cs_html .= jobcareer_special_char($cs_section_title);
            $cs_html .= do_shortcode($content);
            $cs_html .= '</div></div>';
        }
...
if ( ! function_exists('cs_icon_box_item_shortcode') ) {
    ...
    function cs_icon_box_item_shortcode($atts, $content = "") {
        ...
        if ( isset($cs_icon_box_view) && $cs_icon_box_view == 'modern' ) {
            if ( isset($cs_icon_box_view) && $cs_icon_box_view != '' ) {
                ...
                $html .= '<li class="' . $col_class . '"><div class="cs-icon-box ' . $cs_icon_box_content_align . '">';
                ...
                if ( isset($content) && $content != '' ) {
                    ...
                    $html .= '<span ' . $color_string . '>' . $content . '</span> ';
                }
                ...
                if ( (isset($cs_icon_box_title) && $cs_icon_box_title != '')) {
                    ...
                    if ( isset($cs_icon_box_title) && $cs_icon_box_title != '' ) {
                        ...
                        $html .= '<strong ' . $color_string . '><a ' . $color_string . ' href="' . $cs_icon_box_link_url . '">' . $cs_icon_box_title . '</a></strong>';
                    }
